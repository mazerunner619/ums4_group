...
public class NewT implements ActionListener {
    ...
    NewT() {
        ...
        JLabel pageLabel = new JLabel("Teacher Registration Page");
        ...
        JButton TeacherPage = new JButton("Teacher");
        TeacherPage.addActionListener(this);
        leftPanel.add(pageLabel);
        leftPanel.add(homePage);
        leftPanel.add(TeacherPage);
        ...
        int rollno = (int) rn;
        String datas[] = { "First Name", "Last Name", "Date Of Birth", "Phone", "Email", "Course", "ID", "City",
                "Pincode", "Address", "Register By" };
        for (int i = 0; i < 6; i++) {
    ...
    public void actionPerformed(ActionEvent AE) {
        ...
        if (command == "Home") {
            ...
            try {
                ...
                String query = "insert into Teacher values('" + INFO[0] + "','" + INFO[1] + "','" + INFO[2] + "','"
